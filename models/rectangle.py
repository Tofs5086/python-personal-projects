...
#rectangle1 = Rectangle(10, 20, 1, 2, 3)
#print(rectangle1.width)  # Output: 10
#print(rectangle1.height)  # Output: 20
#print(rectangle1.x)  # Output: 1
#print(rectangle1.y)  # Output: 2
#print(rectangle1.id)  # Output: 3

# Create another Rectangle object with keyword arguments
#rectangle2 = Rectangle(width=15, height=25, x=4, y=5, id=6)
#print(rectangle2.width)  # Output: 15
#print(rectangle2.height)  # Output: 25
#print(rectangle2.x)  # Output: 4
#print(rectangle2.y)  # Output: 5
#print(rectangle2.id)  # Output: 6

# Update the attributes of the first rectangle using the update method
#rectangle1.update(7, 30, 40, 6, 7)
#print(rectangle1.width)  # Output: 30
#print(rectangle1.height)  # Output: 40
#print(rectangle1.x)  # Output: 6
#print(rectangle1.y)  # Output: 7
#print(rectangle1.id)  # Output: 7